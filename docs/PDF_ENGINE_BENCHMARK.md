...
logcat, execute o roteiro manual e capture:
...
O relatório contém primeira página, latências p50/p95 de navegação e zoom,
ranges/bytes WebView, PSS, CPU, temperatura e indicadores de ANR, crash e OOM.
...
- Cada engine precisa de pelo menos 3 aberturas e 5 amostras de navegação/zoom;
  ambos os relatórios precisam conter PSS.
