...
> **Status:** Implementação preservada, mas congelada durante o beta — nenhuma sessão, renovação, leitura ou escrita remota deve ser iniciada até a reativação deliberada.
