 ...
 * Uses the shared bottom-sheet transition so list actions and other sheets have
 * identical fade/slide timing and closing behavior.
 */
export function BookListModal({ book, visible, onClose }: Props) {
  ...
  return (
    <ActionSheetModal onClose={handleDismiss} visible={visible}>
      <View
        style={{
